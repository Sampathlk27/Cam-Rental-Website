...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT * FROM rentedcams rc, cams c
    WHERE rc.customer_username='$login_customer' AND c.cam_id=rc.cam_id AND rc.return_status='R'";
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">You have not rented any cameras till now!</h1>
        <p class="text-center"> Please rent cameras in order to view your data here. </p>
      </div>
    </div>
