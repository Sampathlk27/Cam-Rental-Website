    ...
    <ul class="collapsible" data-collapsible="accordion">
      ...
      <li id="dash_products">
        ...
        <div id="dash_products_body" class="collapsible-body">
          <ul>
            <li id="products_product">
              <a class="waves-effect" style="text-decoration: none;" href="products.php">Call Back</a>
            </li>
          </ul>
        </div>
      </li>
  ...
  <header>
    ...
    <nav>
      <div class="nav-wrapper indigo darken-2">
        ...
        <a class="breadcrumb" href="#!">Transactions</a>
...
?>
  <tbody>
    <tr>
      ...
      <td> <a href="edit.php?edit=<?php echo $rows['id']; ?>" class="btn btn-danger" style="height:28 px ; padding-top:0px ">Edit</a>&nbsp&nbsp&nbsp&nbsp</td>
    </tr>
