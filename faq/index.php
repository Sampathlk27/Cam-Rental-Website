        ...
        <div class="cd-faq-items">
            <ul id="basics" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Rent & Relax gladly accepts UPI payments. At this time we would like to advise that personal checks are not accepted locally.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>

                <li>
                    <a class="cd-faq-trigger" href="#0">What if i find a better rate for a rental camera?</a>
                    <div class="cd-faq-content">
                        <p>One of the many great things about Rent & Relax is our rental rates and services are guaranteed to be the very best in the industry. If you come across a lower price from a competitor and the rate is on a comparable camera including the same terms, fees we will be glad to beat the price for you. Please complete our Guaranteed Best Rate form if you have found a better rate with one of our competitors.</div>
                    <!-- cd-faq-content -->
                </li>

                <li>
                    <a class="cd-faq-trigger" href="#0">Will i need a documents to rent a camera?</a>
                    <div class="cd-faq-content">
                        <p>User with a driving license can provide their original Driving License.</p>
                        <p>We also accept any type of <b>Original</b> documents as security.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>

                <li>
                    <a class="cd-faq-trigger" href="#0">Is there a fee if i return the camera after the due date?</a>
                    <div class="cd-faq-content">
                        <p>Yes, we charge the rent for the extended day(s) and a fine of 25% will be added upon the rent amount/day after the due date.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
            </ul>
            ...
            <ul id="membership" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Your privacy is very important to us. As long as you do not share your user name and password with others, no one will be able to see or edit your personal information. For more information, please read our privacy policy.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
                <li>
...
<!-- 
            <ul id="chauffeur" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Rent & Relax gladly accepts MasterCard, Visa, and checks. We also PayTm.</p>
                    </div> -->
                    <!-- cd-faq-content -->
                <!-- </li>
