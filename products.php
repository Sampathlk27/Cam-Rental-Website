  ...
  <header>
    ...
    <nav>
      <div class="nav-wrapper indigo darken-2">
        ...
        <a class="breadcrumb" href="#!">Product Summary</a>
...
<td> <a href="delete1.php?delete=<?php echo $row['cam_id']; ?>" class="btn btn-danger" style="height:28 px ; padding-top:0px ">Delete</a>&nbsp&nbsp&nbsp&nbsp</td>
</tr>
<?php        } ?>
                </table>
                </div> 
