...
<?php
    ...
    $cam_id = $conn->real_escape_string($_POST['hidden_carid']);
    ...
    $sql0 = "SELECT * FROM cams WHERE cam_id = '$cam_id'";
    $result0 = $conn->query($sql0);

    if (mysqli_num_rows($result0) > 0) {
        while($row0 = mysqli_fetch_assoc($result0)) {

             if($type=="ac" && $charge_type == "days"){
    ...
    if($err_date >= 0) { 
    $sql1 = "INSERT into rentedcams(customer_username,cam_id,booking_date,rent_start_date,rent_end_date,fare,charge_type,return_status) 
    VALUES('" . $customer_username . "','" . $cam_id . "','" . date("Y-m-d") ."','" . $rent_start_date ."','" . $rent_end_date . "','" . $fare . "','" . $charge_type . "','" . $return_status . "')";
    $result1 = $conn->query($sql1);
   
    $sql2 = "UPDATE cams SET cam_availability = 'no' WHERE cam_id = '$cam_id'";
    $result2 = $conn->query($sql2);

    $sql4 = "SELECT * FROM  cams c, clients cl, rentedcams rc WHERE c.cam_id = '$cam_id' AND cl.client_username = client_username";
...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <h2 class="text-center"> Thank you for using Rent & Relax!  </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                <h4> <strong>Camer Name: </strong> <?php echo $cam_name; ?></h4>
                <br>
                <h4> <strong>Model Name:</strong> <?php echo $cam_nameplate; ?></h4>
                <br>
                ...
                <br>
                <h4> <strong>Agent Name:</strong>  <?php echo $client_name; ?></h4>
                <br>
                <h4> <strong>Agent Contact: </strong> <?php echo $client_phone; ?></h4>
                <br>    
