...
<head>
    <title> Employee Signup | Rent & Relax  </title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">Rent & Relax - Registration</h1>
            <br>
            <p class="text-center">Create a client account</p>
        </div>
    </div>
                  ...
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    <input type="numeric" class="form-control" id="client_phone"  pattern="[0-9]+" pattern="" maxlength="10" minlength="10" name="client_phone" placeholder="Phone" required="">
                                    <span class="input-group-btn">
