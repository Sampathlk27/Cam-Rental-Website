    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Inventory <span class="caret"></span> </a>
                <ul class="dropdown-menu">
              <li> <a href="returncam.php">Return Now</a></li>
...
function dateDiff($start, $end) {
 ...
 $sql1 = "SELECT c.cam_name, c.cam_nameplate, rc.rent_start_date, rc.rent_end_date,rc.fare, rc.charge_type, cu.customer_name, cu.customer_phone FROM rentedcams rc, cams c, customers cu  WHERE id = '$id' AND c.cam_id=rc.cam_id" ;
 ...
 if (mysqli_num_rows($result1) > 0) 
 {
    while($row = mysqli_fetch_assoc($result1))
     { 
        ...
        $cam_nameplate = $row["cam_nameplate"];
        ...
        $extra_days = dateDiff("$cam_return_date", "$rent_end_date");
    }
}
?>
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 5px; text-align: center; font-size: 30px;"> Return Details </h3>
          <h6 style="margin-bottom: 25px; text-align: center; font-size: 12px;"> </h6>

           <h5> Camera:&nbsp;  <?php echo($cam_name);?></h5>

           <h5> Camera Name:&nbsp;  <?php echo($cam_nameplate);?></h5>

           <h5> Rent date:&nbsp;  <?php echo($rent_start_date);?></h5>

           <h5> Return Date:&nbsp;  <?php echo($rent_end_date);?></h5>
           ...
           <h5> Recipiant Name:&nbsp;  <?php echo($customer_name);?></h5>

           <h5> Recipiant Contact:&nbsp;  <?php echo($customer_phone);?></h5>
          ...
          <?php }  else { ?>
            <h5> Number of Day(s) specified:&nbsp;  <?php echo($no_of_days);?></h5>
            <input type="hidden" name="distance_or_days" value="<?php echo $no_of_days; ?>">
          <?php } ?>
          <input type="hidden" name="hid_fare" value="<?php echo $fare; ?>">
          <h5> Extra Days :  <?php echo $extra_days;?> Day(s).</h5>
           <input type="submit" name="submit" value="Return" class="btn btn-success pull-right">    
        </form>
